    ...
    <div class="row justify-content-center align-items-center" style="height: 100vh;">
        ...
        <div class="col-md-6">
            ...
            <h2 class="text-center text-warning mb-4">Registrar Usuarios</h2>
                ...
                <div class="mb-3">
    <label for="rol" class="form-label">Ingrese su rol</label>
    <select class="form-control form-control-lg" name="Tipo_Usuario" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-lg" id="nombre" name="Nombre" placeholder="Ingrese su nombre completo" required>
        </div>
        
        <div class="mb-3">
            <label for="Documento" class="form-label">Documento</label>
            <input type="number" class="form-control form-control-lg" id="Documento" name="Documento" placeholder="Ingrese su número de documento" required>
        </div>
        <div class="mb-3">
            <label for="Telefono" class="form-label">Teléfono</label>
            <input type="number" class="form-control form-control-lg" id="Telefono" name="Telefono" placeholder="Ingrese su teléfono" required>
        </div>
        <div class="mb-3">
            <label for="email" class="form-label">Correo Electrónico</label>
            <input type="email" class="form-control form-control-lg" id="email" name="Correo" placeholder="Ingrese su correo electrónico" required>
        </div>
        <div class="mb-3">
            <label for="password" class="form-label">Contraseña</label>
            <input type="password" class="form-control form-control-lg" id="password" name="Contraseña" placeholder="Ingrese una contraseña" required>
        </div>
        <div class="mb-3">
            <label for="Direccion" class="form-label">Dirección</label>
            <input type="text" class="form-control form-control-lg" id="Direccion" name="Direccion" placeholder="Ingrese su dirección" required>
        </div>
